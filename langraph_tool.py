...
async def positive_conversation_handler(text: str, session_id: str = "", history_snippets: List[str] = []) -> str:
    ...
    system_prompt = (
        ...
        "  Example: Write 'Bahut achha!' NOT 'बहुत अच्छा!'\n"
...
async def negative_conversation_handler(text: str, session_id: str = "", history_snippets: List[str] = []) -> str:
    ...
    system_prompt = (
        ...
        "  Example: Write 'Tumhe kaisa lag raha hai?' NOT 'तुम्हें कैसा लग रहा है?'\n"
...
class MultilingualDetector:
    ...
    INDIAN_LANGUAGE_PATTERNS = {
        'hindi': {
            ...
            'greeting': 'Namaste! Main aapki baat samajh sakta hoon. 🙏',
        },
        'tamil': {
            'unicode_range': r'[\u0B80-\u0BFF]',
            ...
            'greeting': 'Vanakkam! Naan ungaludan pesalam. 🙏',
        },
        'telugu': {
            'unicode_range': r'[\u0C00-\u0C7F]',
            ...
            'greeting': 'Namaskaram! Nenu meeto matladagalanu. 🙏',
        },
        'bengali': {
            'unicode_range': r'[\u0980-\u09FF]',
            ...
            'greeting': 'Namaste! Ami apnar sathe kotha bolte pari. 🙏',
        },
        'gujarati': {
            'unicode_range': r'[\u0A80-\u0AFF]',
            ...
            'greeting': 'Namaste! Hun tamari sathe vaat kari shaku chhu. 🙏',
        },
        'kannada': {
            'unicode_range': r'[\u0C80-\u0CFF]',
            ...
            'greeting': 'Namaskara! Naanu nimmondige matanaadabahudu. 🙏',
        },
        'malayalam': {
            'unicode_range': r'[\u0D00-\u0D7F]',
            ...
            'greeting': 'Namaskaram! Enikku ningalodu samsarikaam. 🙏',
        },
        'marathi': {
            ...
            'greeting': 'Namaskar! Mi tumchyashi bolu shakto. 🙏',
        },
        'punjabi': {
            'unicode_range': r'[\u0A00-\u0A7F]',
            ...
            'greeting': 'Sat Sri Akal! Main tuhade naal gall kar sakda haan. 🙏',
        }
    }
